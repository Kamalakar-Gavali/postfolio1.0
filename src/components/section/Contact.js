...
const Contact = () => {
    ...
    return (
            ...
            <div className="git-cont row">
                <div className="col-12 col-sm-6 half">
                    <form action={contact.contactUrl ? contact.contactUrl : "https://formspree.io"} method={contact.contactUrl ? "POST" : "GET"}>
                        ...
                        <textarea id="msg" name="message" placeholder="Message" rows={4} style={{resize:'none'}} required ></textarea>
        ...
        <p id="not-dark" className="Copy">Copyright © 2021 <strong>{contact.copyright}</strong>. All Rights Reserved</p>
